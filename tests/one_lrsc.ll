...
define dso_local zeroext i1 @cas_u32(i32 noundef signext %0, i32 noundef signext %1) local_unnamed_addr #0 {
  %3 = cmpxchg volatile ptr @g, i32 %0, i32 %1 seq_cst seq_cst, align 4
